		...
		<div class="box">
			<div class="box-header">
				<div class="box-name">
					...
					<span><strong>Salida de Producto por Servicio</strong></span>
				</div>
				<div class="box-icons">
			...
			<div class="box-content">
				...
				<form class="form-horizontal" role="form" method="post" action="salida/servicio">
					{{ csrf_field() }}
          ...
          <div class="form-group form-inline">
            <div class="col-sm-8 col-sm-offset-7">
              ...
              <input type="text" name="total_a" class="number form-control" value="0.00" id="total_a" readonly="readonly" style="width: 150px">
						...
						<br>
						<input type="button" onclick="form.submit()" style="margin-left:15px; margin-top: 20px;" class="col-sm-2 btn btn-primary" value="Procesar">

						<a href="{{route('salidaserv.in')}}" style="margin-left:15px; margin-top: 20px;" class="col-sm-2 btn btn-danger">Volver</a>
					</div>			
				</form>	
			</div>
		</div>
